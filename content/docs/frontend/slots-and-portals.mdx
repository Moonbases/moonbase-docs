...
## Slots (named render points)
Slots render wherever the app includes `<PluginSlot name="..." />`. The default host already renders the `global` slot in `apps/app/lib/plugins/PluginHost.tsx`.
